...
function Reports() {
  ...
  useEffect(() => {
    const fetchReport = async () => {
      try {
        const response = await fetch('http://127.0.0.1:8000/api/inventory-report/');
  ...
  return (
    <div className="report-container">
      ...
      <a href="http://127.0.0.1:8000/api/inventory-report/?format=csv" className="download-btn" download>
        Download as CSV
      </a>
